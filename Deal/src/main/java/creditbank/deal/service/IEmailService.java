...
public interface IEmailService {
     ...
     */
    void sendDocuments(String topic, String statementId, ApplicationStatus status);
     ...
     * @param statementId идентификатор заявки
     */
    void sendCode(String topic, String statementId);
     ...
     */
    void sendCreditIssuedMessage(String topic, String statementId, String code);
